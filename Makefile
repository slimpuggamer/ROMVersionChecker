...
EE_CFLAGS += -Os -fdata-sections -ffunction-sections -DNEWLIB_PORT_AWARE -Iinclude -Imodules/iopcore/common -Imodules/network/common -I$(PS2SDK)/ports/include
...
EE_LIBS_COMMON = -lc -ldebug -lfileXio -lkernel -lelf-loader -lpatches -lps2ips -lmc -lxcdvd -L$(PS2SDK)/ports/lib -lsiocookie
